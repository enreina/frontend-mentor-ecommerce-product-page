  ...
  <div class="flex flex-col md:flex-row md:mt-20 md:justify-evenly">
    ...
    <div class="p-6 md:max-w-md">
      ...
      <div class="flex flex-col md:flex-row mt-8">
        <button class="w-full bg-orange hover:bg-light-orange text-center text-white py-5 drop-shadow-lg rounded-lg text-base font-bold tracking-wide
        flex flex-row justify-center gap-4 items-center"><svg class="fill-white" width="22" height="20" xmlns="http://www.w3.org/2000/svg">

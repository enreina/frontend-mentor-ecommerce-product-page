...
<template>
    <div class="flex flex-row bg-light-gray-blue justify-between rounded-xl">
        ...
        <input aria-label="Product amount" :min="min" :max="max" class="w-0 grow no-spinner py-4 text-dark-blue text-base font-bold text-center bg-light-gray-blue outline-none appearance-none" type="number" :value="currentValue" @change="onManualChange"/>

...
<template>
    <header class="px-6 md:px-0 flex flex-row gap-4 md:gap-8 md:border-b items-center relative">
        ...
        <button class="relative" @click="isCartOpen = !isCartOpen">
        ...
        <button><img class="rounded-full border-2 border-transparent hover:border-orange transition-[border-color] w-8 h-8 md:w-14 md:h-14" src="../assets/image-avatar.png" /></button>
